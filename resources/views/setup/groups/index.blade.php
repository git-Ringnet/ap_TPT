                                ...
                                <tr>
                                    <th class="height-40 py-0 border-right" scope="col" style="">
                                        <span class="d-flex justify-content-start">
                                            <a href="#" class="sort-link btn-submit" data-sort-by="group_code"
                                                data-sort-type="DESC">
                                    ...
                                    <th class="height-40 py-0 border-right" scope="col" style="">
                                        <span class="d-flex justify-content-start">
                                            <a href="#" class="sort-link btn-submit" data-sort-by="group_name"
                                                data-sort-type="DESC">
                                                <button class="btn-sort" type="submit">
                                                    <span class="text-14">Tên nhóm đối tượng</span>
                                                </button>
                                            </a>
                                            <div class="icon" id="icon-group_name"></div>
                                        </span>
                                    </th>
                                    <th class="height-40 py-0" scope="col" style="">
                                        <span class="d-flex justify-content-start">
                                            <a href="#" class="sort-link btn-submit" data-sort-by="nameGroup"
                                                data-sort-type="DESC">
                                                <button class="btn-sort" type="submit">
                                                    <span class="text-14">Loại nhóm đối tượng</span>
                                                </button>
                                            </a>
                                            <div class="icon" id="icon-nameGroup"></div>
                                        </span>
                                    </th>
                                </tr>
                            </thead>
...
<script type="text/javascript">
    $(document).on('click', '.btn-submit', function(e) {
        ...
        // Gọi hàm AJAX
        var route = "{{ route('filter-groups') }}"; // Thay route phù hợp
