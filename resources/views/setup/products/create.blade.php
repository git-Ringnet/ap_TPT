                        ...
                        <div class="content-info">
                            ...
                            <div class="d-flex align-items-center height-60-mobile">
                                <div class="title-info py-2 border border-left-0 border-top-0">
                                    <p class="p-0 m-0 margin-left32 text-13 required-label">Mã hàng</p>
                                </div>
                                <input type="text" placeholder="Nhập thông tin" name="product_code" required
                                    autocomplete="off"
                            ...
                            <div class="d-flex align-items-center height-60-mobile">
                                <div class="title-info py-2 border border-left-0 border-top-0 height-100">
                                    <p class="p-0 m-0 required-label margin-left32 text-13-black">Tên hàng
                                    </p>
                                </div>
