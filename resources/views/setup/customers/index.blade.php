                            ...
                            <table id="example2" class="table table-hover bg-white rounded">
                                ...
                                <tbody class="tbody-guest">
                                    ...
                                    @foreach ($customers as $item)
                                        @if ($item->group_id == 0)
                                            <tr class="position-relative guest-info height-30">
                                                ...
                                                <td
                                                    class="text-13-black border border-left-0 border-bottom py-0">
                                                    {{ $item->address }}
                                                </td>
                                                <td
                                                    class="text-13-black border border-left-0 border-bottom py-0">
                                                ...
                                                <td
                                                    class="text-13-black border border-left-0 border-bottom py-0">
                                                    {{ $item->email }}</td>
                                                <td class="text-13-black border border-bottom border-left-0 py-0">
                                                    {{ $item->note }}</td>
                                                <td class="position-absolute m-0 p-0 bg-hover-icon icon-center">
                                                    <div class="d-flex w-100">
                                                        <a
                                                            href="{{ route('customers.edit', ['customer' => $item->id]) }}">
                                    ...
                                    @foreach ($groups as $value)
                                        ...
                                        @endphp
                                        <tr>
                                            <td class="text-purble font-weight-bold py-1"
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right guest_debt_total border-bottom" data-id="{{ $value->id }}">
                                            </td>
                                        </tr>
                                    @endforeach
