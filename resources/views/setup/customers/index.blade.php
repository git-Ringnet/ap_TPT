                        ...
                        <div class="outer2 table-responsive text-nowrap">
                            <table id="example2" class="table table-hover bg-white rounded">
                                <thead class="border-custom">
                                    <tr>
                                        <th class="height-40 py-0 border border-top-0 border-right-0 border-bottom-0"
                                            scope="col">
                                        ...
                                        <th class="height-40 py-0 border border-top-0 border-bottom-0" scope="col">
                                            <span class="d-flex justify-content-start">
                                                <a href="#" class="sort-link btn-submit"
                                ...
                                <tbody class="tbody-guest">
                                    <tr>
                                        <td class="text-purble font-weight-bold py-1 border-bottom"
                                    ...
                                    @foreach ($customers as $item)
                                        @if ($item->group_id == 0)
                                            <tr class="position-relative guest-info tr-data height-40">
                                                ...
                                                <td
                                                    class="text-13-black border border-left-0 text-left border-bottom border-top-0 py-0">
                                                    {{ $item->customer_name }}
                                                </td>
                                                <td
                                                ...
                                                <td
                                                    ...
                                                    {{ $item->email }}</td>
                                                <td
                                                    class="text-13-black border border-bottom border-top-0 border-left-0 py-0">
                                                    {{ $item->note }}</td>
                                    ...
                                    <tr class="height-40">
                                        ...
                                        <td class="text-right py-0 border-top-0 border-right border-bottom"
                                            data-id="0" style="color: red">Có
                                            <strong class="total_guest mx-1" data-id="0">
                                                {{ $count }}
                                            </strong> khách hàng
                                        </td>
                                        <td class="border-top-0 border-bottom" colspan="3"></td>
                                        <td class="text-right guest_debt_total border-top-0 border-bottom"
                                            data-id="0">
                                    </tr>
                                    @foreach ($groups as $value)
                                        ...
                                        @endphp
                                        <tr>
                                            <td class="text-purble font-weight-bold py-1 border-top-0"
                                            ...
                                            @if ($item->group_id == $value->id)
                                                ...
                                                <tr class="position-relative guest-info height-40">
                                                    <input type="hidden" name="id-guest" class="id-guest"
                                                        id="id-guest" value="{{ $item->id }}">
                                                    <td
                                                        class="text-13-black border border-left-0 border-bottom-0 py-0">
                                                        <a
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right py-0 border-right border-bottom" style="color: red">
                                                Có
