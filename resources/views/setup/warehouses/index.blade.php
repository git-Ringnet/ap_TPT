            ...
            {{-- <div class="dropdown mx-2 filter-all">
                ...
                <div class="dropdown-menu" id="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <div class="scrollbar">
                        ...
                        <button class="dropdown-item btndropdown text-13-black" id="btn-tenhang" data-button="tenhang"
                            type="button">Tên hàng hóa
                        </button>
                        <button class="dropdown-item btndropdown text-13-black" id="btn-dvt" data-button="dvt"
                            type="button">ĐVT
                        </button>
                        <button class="dropdown-item btndropdown text-13-black" id="btn-gianhap" data-button="gianhap"
                            type="button">Giá nhập
                        </button>
                        <button class="dropdown-item btndropdown text-13-black" id="btn-giabanle" data-button="giabanle"
                            type="button">Giá bán lẻ
                        </button>
                        <button class="dropdown-item btndropdown text-13-black" id="btn-giabansi" data-button="giabansi"
                            type="button">Giá bán sỉ
                        </button>
