        ...
        <div class="content__header--inner">
            <div class="d-flex align-items-center ml-3">
                ...
                <div class="dropdown mx-2 filter-all">
                    ...
                    <div class="dropdown-menu" style="width: 200px;" id="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <div class="scrollbar" id="scrollbar">
                            <button class="dropdown-item btndropdown text-13-black btn-filter border-bottom rounded" type="button">
                                Mã hàng
                            </button>
                            <button class="dropdown-item btndropdown text-13-black btn-filter" type="button">
                                Tên hàng
                            </button>
                        </div>
                    </div>
                        ...
                        <div class="footer-summary">
                            <table class="table-footer">
                                <tr>
                                    ...
                                    <td class="text-danger">Tổng số lượng hàng nhập: <span>{{ $sumImport }}</span>
                                    </td>
                                    <td class="text-danger">Tổng số lượng hàng xuất: <span>{{ $sumExport }}</span>
                                    </td>
                                </tr>
                            </table>
                        </div>
