            ...
            <div class="border">
                <div>
                    ...
                    <div class="d-flex w-100">
                        ...
                        <div
                            class="d-flex w-100 justify-content-between py-2 px-3 border align-items-center text-left text-nowrap position-relative height-44">
                            <span class="text-13 text-nowrap mr-3 required-label" style="flex: 1.5;">Khách hàng</span>
                    ...
                    <div class="d-flex w-100">
                        ...
                        <div
                            class="d-flex w-100 justify-content-between py-2 px-3 border align-items-center text-left text-nowrap position-relative height-44">
                            <span class="text-13 btn-click required-label" style="flex: 1.6;"> Người liên hệ </span>
                    ...
                    <div class="d-flex w-100">
                        <div
                            ...
                            <input class="text-13-black w-50 border-0 bg-input-guest bg-input-guest-blue py-2 px-2"
                                autocomplete="off" placeholder="Nhập thông tin" style="flex:2;" name="user_id" />
                        </div>
                        <div
                            class="d-flex w-100 justify-content-between py-2 px-3 border align-items-center text-left text-nowrap position-relative height-44">
